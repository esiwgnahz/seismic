...
contains
  ...
  subroutine THREEDAFWI_doc()
    ...
    call sep_add_doc_line("")
    call Com_doc()
    call sep_add_doc_line("OPTIONAL INPUT PARAMETERS MUTING")
    call sep_add_doc_line("")
    call sep_add_doc_line("   v0 - float")
    call sep_add_doc_line("      1500 m/s - top mute velocity")
    call sep_add_doc_line("   v1 - float")
    call sep_add_doc_line("      10000 m/s - bottom mute velocity")
    call sep_add_doc_line("")
    call sep_add_doc_line("   t0 - float")
    call sep_add_doc_line("      0 s. - top mute time")
    call sep_add_doc_line("   t1 - float")
    call sep_add_doc_line("      40 s. - bottom mute time")
    call sep_add_doc_line("")
    call sep_add_doc_line("   tramp - float")
    call sep_add_doc_line("      0.5 s - size of taper window for mute from 0 to 1")
    call sep_add_doc_line("")
    ...
    call sep_add_doc_line("   mute_in - sepfile")
    call sep_add_doc_line("         mute.H (nt,ntraces) = input weighting W")
    call sep_add_doc_line("")
    call sep_add_doc_line("")
    ...
    call sep_add_doc_line("")
    call sep_add_doc_line("OPTIONAL OUTPUT FILES")
    call sep_add_doc_line("")
    call sep_add_doc_line("   residual - sepfile")
    call sep_add_doc_line("         res.H (nt,ntraces) = residual W(f(m)-d)")
    call sep_add_doc_line("")
    call sep_add_doc_line("   dmod - sepfile")
    call sep_add_doc_line("         dmod.H (nt,ntraces) = modeled data Wf(m)")
    call sep_add_doc_line("")
    call sep_add_doc_line("   mute_out - sepfile")
    call sep_add_doc_line("         mute.H (nt,ntraces) = residual weight W")
    call sep_add_doc_line("")
