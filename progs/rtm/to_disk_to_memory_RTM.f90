module to_disk_to_memory_RTM_mod
  ...
  contains
    ...
    subroutine CHEAP_LSRTM_to_disk(mod,genpar,dat,bounds,elev,datavec,sourcevec)
    ...
    end subroutine CHEAP_LSRTM_to_disk
    ...
    subroutine CHEAP_LSRTM_to_memory(mod,genpar,dat,bounds,elev,datavec,sourcevec)
    ...
    end subroutine CHEAP_LSRTM_to_memory
