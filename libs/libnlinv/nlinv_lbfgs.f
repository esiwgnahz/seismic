...
C     ****************
C
      SUBROUTINE LBFGSOC(N,M,X,F,G,DIAGCO,DIAG,IPRINT,EPS,XTOL,
     *              STEPINIT, W,IFLAG,
...
C
      ...
      DOUBLE PRECISION F,EPS,XTOL,STEPINIT
      LOGICAL DIAGCO
...
C 
C    Other routines called directly:  DAXPY, DDOT, LB6, MCSRCH
C 
...
C      FTOL= 1.0D-4
      MAXFEV= 20
C
      IF(IPRINT(1).GE.0) CALL LB6(IPRINT,ITER,NFUN,
...
C
      ...
      COMMON /LB5/MP,LP,GTOL,STPMIN,STPMAX
      DATA MP,LP,GTOL,STPMIN,STPMAX/1020,0,0.9D+00,1.0D-20,1.0D+20/
      END

      SUBROUTINE LB6(IPRINT,ITER,NFUN,
     *                     GNORM,N,M,X,F,G,STP,FINISH)
C
C     -------------------------------------------------------------
...
C     ****************
C
      SUBROUTINE LBFGSOLD(N,M,X,F,G,DIAGCO,DIAG,IPRINT,EPS,XTOL,
     *              STEPINIT,W,IFLAG,
     *              MYINFO, LBFGS_DAT, LBFGSOUT_DAT, MCSRCH_DAT,
     *              MCSRCHOUT_DAT)
C
