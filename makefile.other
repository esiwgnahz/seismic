...
#UF90LIBS:= ${UF90LIBS} -lbei  -L/${MKLROOT}/lib/intel64 -lsupersetf90 -lsuperset -lfftw3f ${GEELIB} -lAdec -lAinv -lAfut -lsepgeef90
UF90LIBS= -L/u/st/by/aguitton/bins/fftw/lib/ -qopenmp  -lsepfft -lsep2df90 -lsep3df90 -lsep3d -lsepf90 -lsep -lsupersetf90 -lsuperset  -lfftw3f  -L/${MKLROOT}/lib/intel64 -qopenmp -lmkl_intel_lp64 -lmkl_lapack95_lp64 -lmkl_core -lmkl_intel_thread -lpthread -lm -ldl -lAdec -lAinv -lAfut 
